 ...
 */
class VF_Wheel_BoltPattern_Dual extends VF_Wheel_BoltPattern
{
    /** @var VF_Wheel_BoltPattern */
    ...
    function __construct($formattedString)
    {
        ...
        $this->left = VF_Wheel_BoltPattern::createFromValues($lug_count, $bolt_distance[0]);
        $this->right = VF_Wheel_BoltPattern::createFromValues($lug_count, $bolt_distance[1]);
    }
