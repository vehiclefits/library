 ...
 */
class VF_Tire_FinderTests_DiameterTest extends VF_TestCase
{
    function testShouldFindAll()
    {
        $this->newTireProduct(1, new VF_TireSize(null, null, 16));
        $this->assertEquals(array(16 => 16), $this->tireFinder()->diameters(), 'should find possible diameter');
    }

    function testShouldSort()
    {
        $this->newTireProduct(1, new VF_TireSize(null, null, 18));
        $this->newTireProduct(2, new VF_TireSize(null, null, 15));
