 ...
 */
class VF_Tire_FlexibleSearchTests_SectionWidthTest extends VF_TestCase
{
    function testShouldGetFromRequest()
    {
        $flexibleSearch = $this->flexibleTireSearch(
            array('section_width' => '205', 'aspect_ratio' => '55', 'diameter' => '16')
        );
    ...
    function testShouldClearFromSession()
    {
        ...
        $this->getServiceContainer()->storeFitInSession();
        $flexibleSearch = $this->flexibleTireSearch(
            array('section_width' => '0', 'aspect_ratio' => '0', 'diameter' => '0')
        );
        $this->getServiceContainer()->storeFitInSession();
