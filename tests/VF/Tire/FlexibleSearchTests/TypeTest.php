 ...
 */
class VF_Tire_FlexibleSearchTests_TypeTest extends VF_TestCase
{
    function testShouldGetFromRequest()
    {
        $flexibleSearch = $this->flexibleTireSearch(
            array('tire_type' => 2, 'section_width' => '205', 'aspect_ratio' => '55', 'diameter' => '16')
        );
    ...
    function testShouldClearFromSession()
    {
        ...
        $this->getServiceContainer()->storeFitInSession();
        $flexibleSearch = $this->flexibleTireSearch(
            array('tire_type' => '', 'section_width' => '0', 'aspect_ratio' => '0', 'diameter' => '0')
        );
        $this->getServiceContainer()->storeFitInSession();
